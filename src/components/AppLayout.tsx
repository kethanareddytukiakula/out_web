          ...
          <div className="p-3 rounded-2xl" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-white truncate" style={{ fontFamily: 'var(--font-display)', fontWeight: 700 }}>{currentUser?.name || 'User'}</p>
                <p className="text-[10px]" style={{ color: '#8888aa' }}>{userCourseYear}</p>
              </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full" style={{ background: '#0d0d1a' }}>
        ...
        <header className="h-14 flex items-center px-6 gap-4 flex-shrink-0" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)', background: 'rgba(13,13,26,0.9)', backdropFilter: 'blur(12px)' }}>
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <div className="w-9 h-9 rounded-xl flex items-center justify-center text-xs text-white" style={{ background: 'linear-gradient(135deg, #f72585, #7209b7)', fontFamily: 'var(--font-display)', fontWeight: 800 }}>
              {userInitials}
            </div>
          </div>
        </header>
